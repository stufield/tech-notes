...
In this calculation, significance threshold ($\alpha$) has been Bonferroni
corrected (i.e. $0.05/1129 =$ `r format(0.05/1129, digits = 4, scientific = FALSE)`),
...
in **Eqn 1.**, where the *relative* differences in the means based on %CV
