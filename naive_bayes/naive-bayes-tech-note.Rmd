...
over *absolute* posteriors. Equation~\@ref(eq:binom) then simplifies to,
...
The result of equation~\eqref{eqn:bayes} gives a probability *density* for
...
$$
\begin{eqnarray} %\label{eqn:bayes_prob}
...
From equation~\eqref{eqn:bayes_prob}, the relative proportion of each density is:
